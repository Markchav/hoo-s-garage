...
{/* Home Section */}
      <div className='flex items-center justify-center h-[450px] sm:h-[680px] max-lg:h-[485px] mb-12 sm:bg-fixed bg-center bg-[url(../public/images/bmw-edit.png)] sm:bg-cover bg-[length:620px_600px]'/>
